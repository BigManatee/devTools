...
<head>
    ...
    <title>Color from Image | Tools - Things I often find myself using | iamtyler.sh</title>
    <meta name="title" content="Color from Image | Tools - Things I often find myself using | iamtyler.sh">
    <meta name="description" content="Color from Image | Tools - Things I often find myself using | iamtyler.sh" />
