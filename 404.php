            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="panel-standard">
                        <h3>Sorry, it seems this page doesn’t exist!</h3>
                        <span class="sub-title">Make sure you typed the right URL or clicked on the right thing, it may just been that the page you was looking for has moved. Go <a href="index">Home</a></span>
                    </div>
                </div>
            </div>
        </div>
