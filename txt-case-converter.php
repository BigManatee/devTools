...
<head>
    ...
    <title>Text Case Converter | Tools - Things I often find myself using | tyler.ac</title>
    <meta name="title" content="Text Case Converter | Tools - Things I often find myself using | tyler.ac">
    <meta name="description" content="Text Case Converter | Tools - Things I often find myself using | tyler.ac" />
    ...
    <link href="assets/css/tcc.css?v={{ date().timestamp }}" rel="stylesheet">
